...
jQuery(document).ready(function() {
	...
	jQuery('#group_slider').click(function() {
		jQuery('#section-group_slider_n, #section-group_slider_url, #section-group_slider_t, #section-tr_rslides_img').fadeToggle(400);
	});

	if (jQuery('#group_slider:checked').val() !== undefined) {
		jQuery('#section-group_slider_n, #section-group_slider_url, #section-group_slider_t, #section-tr_rslides_img').show();
	}
