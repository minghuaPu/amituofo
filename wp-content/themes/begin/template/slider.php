	...
	<ul class="rslides" id="slider">
		...
		<?php $go_url = get_post_meta($post->ID, 'show_url', true); ?>
			<li>
				...
				<?php endif; ?>
				<p class="slider-caption"style="background-color:#000;opacity:0.6;  font-size:25px;text-align:center;line-height: 35px;  width:100%;height:40px;margin-top:380px;overflow:hidden;"><?php the_title(); ?></p>
			</li>
