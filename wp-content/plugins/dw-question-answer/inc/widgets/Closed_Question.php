...
class DWQA_Widgets_Closed_Question extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'dwqa-widget dwqa-closed-questions', 'description' => __( '已关闭的问题列表。', 'dwqa' ) );
		parent::__construct( 'dwqa-closed-question', __( 'DWQA 已关闭的问题', 'dwqa' ), $widget_ops );
	}
