...
class DWQA_Widgets_Related_Question extends WP_Widget {
	...
	function __construct() {
		$widget_ops = array( 'classname' => 'dwqa-widget dwqa-related-questions', 'description' => __( '相关问题列表。仅显示在问题页面', 'dwqa' ) );
		parent::__construct( 'dwqa-related-question', __( 'DWQA 相关问题', 'dwqa' ), $widget_ops );
	}
