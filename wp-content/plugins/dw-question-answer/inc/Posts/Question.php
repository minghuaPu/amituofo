...
class DWQA_Posts_Question extends DWQA_Posts_Base {
	...
	public function register_taxonomy() {
		...
		$labels = array(
			'name'              => _x( '问题分类', 'taxonomy general name', 'dwqa' ),
			'singular_name'     => _x( '问题分类', 'taxonomy singular name', 'dwqa' ),
			'search_items'      => __( '搜索问题分类', 'dwqa' ),
			'all_items'         => __( '全部问题分类', 'dwqa' ),
			'parent_item'       => __( '父级问题分类', 'dwqa' ),
			'parent_item_colon' => __( '父级问题分类:', 'dwqa' ),
			'edit_item'         => __( '编辑问题分类', 'dwqa' ),
			'update_item'       => __( '更新问题分类', 'dwqa' ),
			'add_new_item'      => __( '添加新问题分类', 'dwqa' ),
			'new_item_name'     => __( '新的问题分类名称', 'dwqa' ),
			'menu_name'         => __( '问题分类', 'dwqa' ),
		);
		...
		$labels = array(
			'name'                       => _x( '问题标签', 'taxonomy general name', 'dwqa' ),
			'singular_name'              => _x( '问题标签', 'taxonomy singular name', 'dwqa' ),
			'search_items'               => __( '搜索问题标签', 'dwqa' ),
			'popular_items'              => __( '热门标签', 'dwqa' ),
			'all_items'                  => __( '全部问题标签', 'dwqa' ),
			'parent_item'                => null,
			'parent_item_colon'          => null,
			'edit_item'                  => __( '编辑问题标签', 'dwqa' ),
			'update_item'                => __( '更新问题标签', 'dwqa' ),
			'add_new_item'               => __( '添加新问题标签', 'dwqa' ),
			'new_item_name'              => __( '新问题标签名称', 'dwqa' ),
			'separate_items_with_commas' => __( '多个标签请用英文逗号（,）分开', 'dwqa' ),
			'add_or_remove_items'        => __( 'Add or remove question tags', 'dwqa' ),
			'choose_from_most_used'      => __( '从常用问题标签中选择', 'dwqa' ),
			'not_found'                  => __( '没有问题标签', 'dwqa' ),
			'menu_name'                  => __( '问题标签', 'dwqa' ),
		);
