...
class DWQA_Admin_Extensions {
	...
	function register_extension_menu() {
		add_submenu_page( 'edit.php?post_type=dwqa-question', __( 'Extensions', 'dwqa' ), sprintf( '<span>%s</span>', __( 'Extensions', 'dwqa' ) ), 'manage_options', 'dwqa-extensions', array( $this, 'extension_menu_layout' ) );
	}
